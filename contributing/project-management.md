...
| 6. | The issue is estimated using story pointing in the fibonacci format and moved to the [Execution][execution] project board Backlog column. | `Project Manager` `Engineer`

##### Execution
| Step | Task | Role  |
| :--- | :--- | :--- |
| 1. | An issue requiring work is added to the [Execution][execution] project board Backlog column after going through the [Definition][definition] project board pipeline. | `Project Manager`
...
| 4. | The issue is estimated using using story pointing in the fibonacci format and moved to the [Execution][execution] project board Backlog column. | `Task specific`
...
[milestones]: https://github.com/xwp/unsplash-wp/milestones
[issues]: https://github.com/xwp/unsplash-wp/issues
[definition]: https://github.com/xwp/unsplash-wp/projects/1
[execution]: https://github.com/xwp/unsplash-wp/projects/2
