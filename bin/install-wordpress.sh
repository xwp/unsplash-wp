...
HOST_PORT=$(docker-compose -f docker-compose.yml port $CONTAINER 80 | awk -F : '{printf $2}')
...
# Activate Unsplash plugin.
echo -e $(status_message "Activating Unsplash plugin...")
wp plugin activate unsplash-wp --quiet
