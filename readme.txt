...
== Description ==
With Unsplash for Wordpress, search and use the internet’s largest library of freely usable images right from the WordPress editor. Access millions of HD photos for free, with no strings attached.

## Search
Search for the perfect image for your content from [Unsplash](https://unsplash.com) directly from your WordPress editor. Keyword search with instant results presents you with a beautiful list of gorgeous images that you can use freely, with no stock image licensing or attribution required.

## Adding images to your content
Adding an image to your post is super easy. With one click the image is added both to your post, and automatically downloaded and added to your Media Library. Supports both Gutenberg and Classic editors.

Features

* Free - all images are completely free to use for both commercial and personal uses. No strings attached.
* Keyword search - search from our massive library of millions of free to use images using keyword search.
* Instant results - view search results instantly, no waiting for pages of results.
* Easy to access - the Unsplash tab is presented whenever you want to add an image.
* Automatic import into Media Library - the images you select are automatically added to your WordPress site\'s Media Library.
* Gutenberg - use the existing image block, or the cover block to add Unsplash images to your content via the Gutenberg editor.
* Classic - use the existing Add Media button to add Unsplash images to your content via the Classic editor.
...
* Graceful Failover - Intelligent plugin design ensures that your site\'s images will continue to appear to the user even if the Unsplash plugin is disabled.
